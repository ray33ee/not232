...
#define RECV_FLASHFS_REMOVE         ((uint8_t)235)
#define RECV_FLASHFS_MOVE           ((uint8_t)236)
#define RECV_FLASHFS_FILE_INFO      ((uint8_t)237)
#define RECV_FLASHFS_FILE_OPEN      ((uint8_t)238)
#define RECV_FLASHFS_FILE_CLOSE     ((uint8_t)239)
#define RECV_FLASHFS_FILE_READ      ((uint8_t)240)
#define RECV_FLASHFS_FILE_WRITE     ((uint8_t)241)
#define RECV_FLASHFS_FILE_SEEK      ((uint8_t)242)
#define RECV_FLASHFS_FILE_TRUNCATE  ((uint8_t)243)
#define RECV_FLASHFS_MKDIR          ((uint8_t)244)
#define RECV_FLASHFS_DIR_OPEN       ((uint8_t)245)
#define RECV_FLASHFS_DIR_CLOSE      ((uint8_t)246)
#define RECV_FLASHFS_DIR_READ       ((uint8_t)247)
